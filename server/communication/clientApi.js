...
const ClientApi = {
	...
	requestTrumpf(client, isGeschoben) {
		return this.clientCommunication.request(client, MessageType.REQUEST_TRUMPF.name, MessageType.CHOOSE_TRUMPF, this.timeoutInSeconds, isGeschoben);
	},

	suggestTrumpf(client, gameType) {
		this.clientCommunication.send(client, MessageType.SUGGEST_TRUMPF.name, gameType);
	},
	...
	suggestCard(client, card) {
		this.clientCommunication.send(client, MessageType.SUGGEST_CARD.name, card);
	},
